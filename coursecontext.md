...
> **Purpose**: This file provides context about this repository and its goals. Add any additional information below.

## About This Repo

This repository is based on the **Code Your Future – Structuring and Testing Data** module (JavaScript). The goal is to create **extra coding challenges** for fellow students so everyone in the group can practice more if they want.

## Current Content (from original coursework)
...
- Interpreting percentage change, time formatting, pence-to-pounds conversion
